...
},
{
  ...
  "body": " (exemples génériques d'utilisation de la formule des probabilités totales)     si on fixe un événement alors     Si sont des événements quelconques alors      "
},
{
  ...
  "number": "1.22",
  "title": "",
  "body": "    Ce résultat reste valable si les événements sont deux à deux disjoints, sans former une partition de , à condition que     Cette formule est extrêmement utile. Elle stipule que si on sait calculer les probabilités des événements d'un SCE alors on peut exprimer la probabilité de n'importe quel événement.    Reprenons le contexte de la et considérons une famille de nombre réel positifs dont la somme vaut . Alors on définit complétement une probabilité sur l'espace en posant On a alors pour tout    Le théorème suivant n'est qu'un cas particulier de ce dernier résultat.     "
},
{
  "id": "thm-probadisc",
  "level": "2",
...
},
{
  ...
  "number": "1.51",
  "title": "",
  "body": "  Soit une variables aléatoire discrète de dans .    est un système complet d'événements de ;    Pour tout ,    Pour une variable aléatoire discrète  , déterminer la loi de revient ainsi à déterminer le couple . L'application est dite fonction des masses de la variable .   La loi d'une VADR est ainsi déterminée par le couple formé de l'ensemble des valeurs qu'elle peut prendre et de la famille (au plus dénombrable) des probabilités pour que chacune de ces valeurs se réalise.    "
},
{
  "id": "cor-memeloi",
  "level": "2",
  ...
  "number": "1.52",
  "title": "",
  "body": "  Soient et deux VAD. Si et suivent la même loi alors pour toute fonction définie sur , les variables et suivent la même loi.    Si alors et donc . Soit ensuite , alors Ainsi    "
},
{
  "id": "def-loicouple",
  "level": "2",
...
{
  "id": "subsec-loivaralea-5",
  "level": "2",
  "url": "sec-varalea.html#subsec-loivaralea-5",
  "type": "Remarque",
  "number": "1.54",
  "title": "",
...
},
{
  ...
  "body": " Exploration graphique   Exploration de la loi binomiale   Dans cette activité, vous allez explorer comment les paramètres (nombre d'essais) et (probabilité de succès) influencent la forme de la distribution binomiale. Vous pourrez choisir différentes valeurs de et et observer l'histogramme correspondant.    Utiliser les curseurs ci-dessous pour choisir les valeurs de et , puis observer comment l'histogramme de la loi binomiale évolue.    En modifiant les valeurs de et , observer comment la forme de la distribution binomiale change :  Si , la distribution est symétrique.  Si , la distribution est décalée vers la gauche.  Si , la distribution est décalée vers la droite.  Plus est grand, plus la distribution ressemble à une courbe en cloche (approximation normale).      Expliquer théoriquement vos observations     Comportement asymptotique d'une loi binomiale   Visualiser l'approximation de la loi binomiale par la loi de Poisson lorsque est grand.  Ce graphique affiche en bleu l'histogramme de la loi binomiale et en rouge la courbe de la loi de Poisson . Il permet de visualiser comment la distribution binomiale se rapproche de la distribution de Poisson lorsque devient grand.    Lorsque est grand et est petit, la distribution binomiale devient similaire à la distribution de Poisson . Cette visualisation interactive permet d'observer cette convergence.    Expliquer théoriquement vos observations    "
},
{
  "id": "sec-expgraph-2",
  "level": "2",
  "url": "sec-expgraph.html#sec-expgraph-2",
  "type": "Activité",
  "number": "2.1",
  "title": "Exploration de la loi binomiale.",
  "body": " Exploration de la loi binomiale   Dans cette activité, vous allez explorer comment les paramètres (nombre d'essais) et (probabilité de succès) influencent la forme de la distribution binomiale. Vous pourrez choisir différentes valeurs de et et observer l'histogramme correspondant.    Utiliser les curseurs ci-dessous pour choisir les valeurs de et , puis observer comment l'histogramme de la loi binomiale évolue.    En modifiant les valeurs de et , observer comment la forme de la distribution binomiale change :  Si , la distribution est symétrique.  Si , la distribution est décalée vers la gauche.  Si , la distribution est décalée vers la droite.  Plus est grand, plus la distribution ressemble à une courbe en cloche (approximation normale).      Expliquer théoriquement vos observations   "
},
{
  "id": "sec-expgraph-3",
  "level": "2",
  "url": "sec-expgraph.html#sec-expgraph-3",
  "type": "Activité",
  "number": "2.2",
  "title": "Comportement asymptotique d’une loi binomiale.",
  "body": " Comportement asymptotique d'une loi binomiale   Visualiser l'approximation de la loi binomiale par la loi de Poisson lorsque est grand.  Ce graphique affiche en bleu l'histogramme de la loi binomiale et en rouge la courbe de la loi de Poisson . Il permet de visualiser comment la distribution binomiale se rapproche de la distribution de Poisson lorsque devient grand.    Lorsque est grand et est petit, la distribution binomiale devient similaire à la distribution de Poisson . Cette visualisation interactive permet d'observer cette convergence.    Expliquer théoriquement vos observations   "
},
{
...
{
  "id": "sec-principeinversion-6",
  "level": "2",
  "url": "sec-principeinversion.html#sec-principeinversion-6",
  "type": "Activité",
  "number": "2.3",
...
{
  "id": "sec-principeinversion-7",
  "level": "2",
  "url": "sec-principeinversion.html#sec-principeinversion-7",
  "type": "Activité",
  "number": "2.4",
